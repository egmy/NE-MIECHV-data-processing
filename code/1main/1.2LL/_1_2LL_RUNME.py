...
path_12LL_dir_backup=Path(path_12LL_files_base, 'backup')
###########################
...
if backup:
    df_12LL_BaseTable.to_csv(Path(path_12LL_dir_backup, 'df_12LL_BaseTable.csv'), index = False, date_format="%m/%d/%Y")
    df_12LL_pivoted_ChildERInj_2.to_csv(Path(path_12LL_dir_backup, 'df_12LL_pivoted_ChildERInj_2.csv'), index = False, date_format="%m/%d/%Y")
    df_12LL_pivoted_MaternalIns_3.to_csv(Path(path_12LL_dir_backup, 'df_12LL_pivoted_MaternalIns_3.csv'), index = False, date_format="%m/%d/%Y")
    df_12LL_pivoted_WellChildVisits_4.to_csv(Path(path_12LL_dir_backup, 'df_12LL_pivoted_WellChildVisits_4.csv'), index = False, date_format="%m/%d/%Y")
