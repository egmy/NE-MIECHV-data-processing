...
path_11FW_dir_backup=Path(path_11FW_files_base, 'backup')
...
if backup:
    df_11FW_adult_act.to_csv(Path(path_11FW_dir_backup, 'df_11FW_adult_act.csv'), index = False, date_format="%m/%d/%Y")
    df_11FW_child_act.to_csv(Path(path_11FW_dir_backup, 'df_11FW_child_act.csv'), index = False, date_format="%m/%d/%Y")
    df_11FW_pivoted_child_injury.to_csv(Path(path_11FW_dir_backup, 'df_11FW_pivoted_child_injury.csv'), index = False, date_format="%m/%d/%Y")
    df_11FW_pivoted_cg_ins.to_csv(Path(path_11FW_dir_backup, 'df_11FW_pivoted_cg_ins.csv'), index = False, date_format="%m/%d/%Y")
    df_11FW_pivoted_well_child.to_csv(Path(path_11FW_dir_backup, 'df_11FW_pivoted_well_child.csv'), index = False, date_format="%m/%d/%Y")
