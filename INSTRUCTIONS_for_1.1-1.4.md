...
2. Below, make a new line for objects "str_nehv_quarter" & "previous_str_nehv_quarter" -- set to the same text name of the new quarter (or previous quarter for previous quarter variable) used for creating input/output folders.
